...
from src.agentic_rag.tools.custom_tool import DocumentSearchTool, FirecrawlWebSearchTool

@st.cache_resource
def load_llm():
    # Fetch the Groq API key securely from Streamlit's secrets environment
    groq_key = st.secrets.get("GROQ_API_KEY", "")
    
    # Initialize the high-speed Llama model in the cloud
    llm = LLM(
